...
@protocol CGMeetViewDelegate <NSObject>
 ...
 * associated `CGMeetView`. The latter will automatically detect its new size
...
/**
 * Called when loading the main configuration file from the CG Meet
 * deployment file.
 *
